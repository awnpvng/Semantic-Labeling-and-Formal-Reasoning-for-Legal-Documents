                ...
                if (typeof q.answer === 'boolean') {
                    answerHTML = `
                        <div class="query-answer">
                            <span class="answer-count">${q.answer ? 'true' : 'false'}</span>
                        </div>
                    `;
                } else if (Array.isArray(q.answer)) {
                    answerHTML = `
                        <div class="query-answer">
                            <span class="answer-count">${q.answer_count} kết quả</span>
                            <div class="answer-list">
                                ${q.answer.map(a => `<div class="answer-item">${a}</div>`).join('')}
                            </div>
                        </div>
                    `;
                }
            } else {
                answerHTML = `<div class="query-answer"><span class="answer-count">Không có kết quả</span></div>`;
            }
